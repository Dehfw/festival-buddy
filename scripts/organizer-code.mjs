 ...
 * (/app/veranstalter) zum Veranstalter eines Festivals macht. Es gibt bewusst
...
try {
  ...
  if (command === 'generate') {
    ...
    console.log('');
    console.log(`  Einlösen in der App unter /app/veranstalter?code=${formatInviteCode(code)}`);
