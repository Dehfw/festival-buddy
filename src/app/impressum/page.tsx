 ...
 * Startseite. Privates, nicht-kommerzielles Crew-Tool, daher schlank.
 */
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-bone">
          ...
          <section>
            ...
            <p className="mt-2 text-ash">
              ...
              unsere Crew. Für eigene Inhalte auf diesen Seiten sind wir nach
              den allgemeinen Gesetzen verantwortlich. Nutzergenerierte Inhalte
              (z. B. Namen, Gruppen, Band-Auswahl) geben die Ansicht der
              jeweiligen Mitglieder wieder. Bandnamen, Timetable und Logos sind
