...
/* ------------------------------------------------------------------ */
/* Öffentliche Veranstalter-Seite (/fuer-veranstalter). Erklärt den    */
...
/* Das eigentliche Werkzeug lebt unter "/veranstalter".                */
/* ------------------------------------------------------------------ */
...
const STEPS: { n: string; title: string; body: string }[] = [
  ...
  },
  {
    n: '03',
    title: 'Loslegen',
    body: 'Tage, Bühnen, Slots und Bühnenpläne anlegen. Deine Besucher planen ab der ersten Minute mit – und sehen jede Änderung sofort.',
  },
];

export default async function FuerVeranstalterPage() {
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mx-auto mt-7 max-w-xl text-base leading-relaxed text-ash sm:text-lg lg:mx-0">
              ...
              Bühnenpläne und Mitteilungen deines Festivals selbst – jede
              Änderung landet in Sekunden bei allen. 🤘
            </p>
